...
MEMAs are spotted cellular microarrays that are fluorescently imaged at quantitated at the cell level. Each spot can have different microenvironment proteins and be exposed to different ligands and possibly drugs.  The arrays are in wells that expose the cells to combinations of ligands and drugs. MEMAs can be in 96 well plates which typically hold 64 spots or in 8 well plates that can hold an array of ~700 spots.
